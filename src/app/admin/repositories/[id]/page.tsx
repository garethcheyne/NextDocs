  ...
  return (
    <>
      ...
      <div className="flex-1 p-6 space-y-6 overflow-auto">
        ...
        {/* Status Banner */}
        <Card className={`border-2 ${displayStatus === 'Active'
            ...
            <div className="flex items-center justify-between">
              <div>
                <div className="flex items-center gap-2">
                  <span className={`text-lg font-semibold ${displayStatus === 'Active' ? 'text-green-600 dark:text-green-400' :
                ...
                {repository.syncLogs.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {repository.syncLogs.map((log: any) => (
                      ...
                      >
                        <div
                          className={`w-2 h-2 rounded-full mt-2 ${log.status === 'success'
                            ? 'bg-green-500'
                            : log.status === 'failed'
                              ? 'bg-red-500'
                              : 'bg-blue-500'
