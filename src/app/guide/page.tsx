            ...
            <div className="space-y-6">
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    <Link href="/guide/getting-started">
                        <Card className="hover:border-primary/50 transition-colors cursor-pointer h-full bg-white/50 dark:bg-gray-900/40 border-gray-200/50 dark:border-gray-800/50 backdrop-blur-xl">
                            <CardHeader>
